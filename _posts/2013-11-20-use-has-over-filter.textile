...
{% highlight text %}
gremlin> s=System.currentTimeMillis();g.V.has("r",T.gte,"00000000000").has("i",T.gte,200000).iterate();System.currentTimeMillis()-s
==>95
gremlin> s=System.currentTimeMillis();g.V.filter{it.r>="00000000000" && it.i>=200000}.iterate();System.currentTimeMillis()-s       
==>5521
{% endhighlight %}
