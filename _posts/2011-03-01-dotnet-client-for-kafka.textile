...
I executed the first commit to "my fork":https://github.com/spmallette/kafka which contained basic support for a .NET message producer.  The basic approach to sending off one or more messages looks something like this:
