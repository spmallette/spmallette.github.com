...
"Rexster":http://rexster.tinkerpop.com is a graph server that is capable of exposing any "Blueprints":http://blueprints.tinkerpop.com enabled graph through different interfaces, such as REST.  Rexster is "packaged" with the common Blueprints implementations that are maintained by "TinkerPop":http://tinkerpop.com.  At this time, given Rexster 0.8, those implementations include:
